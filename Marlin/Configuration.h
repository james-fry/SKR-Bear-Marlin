...
#define STRING_CONFIG_H_AUTHOR "(Chris Warkocki, SKR 1.4 Turbo Custom Build)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Maurice"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33.5, 5, 0 }
